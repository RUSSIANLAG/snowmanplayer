...
public class SnowmanRunner {
    ...
    public static void main(String[] args) {
        ...
        final int SEED = 416647905;//1132345;//6789733;
        final String PASSPHRASE = "Two short camels carry my dapanzi to the dinner table";// as illustrated in https://xkcd.com/936/
